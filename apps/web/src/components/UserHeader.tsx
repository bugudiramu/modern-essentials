  ...
  return (
    <>
            ...
            <div className="flex items-center gap-6 md:gap-10">
              <div className="flex items-center gap-2">
                ...
                <Link href="/" className="group outline-none">
                  <Heading
                    variant="h3"
                    className="text-lg md:text-xl tracking-tighter text-primary font-bold group-hover:text-secondary transition-colors"
                  >
                    The Honest Essentials
                  </Heading>
                </Link>
              </div>
                  ...
                  <NavigationMenuItem>
                    <Link href="/products" legacyBehavior passHref>
                      <NavigationMenuLink
                        className={cn(
                          navigationMenuTriggerStyle(),
                          "bg-transparent text-[9px] font-black tracking-[0.1em] uppercase text-primary/60 hover:text-primary h-8 px-3",
                        )}
                      >
                        Shop
                      </NavigationMenuLink>
              ...
              {isSignedIn && (
                <nav className="hidden lg:flex items-center gap-5 pr-5 border-r border-primary/5">
                  ...
                  >
                    ...
                    <Text
                      variant="xs"
                      className="text-[7px] text-primary/30 group-hover:text-primary transition-colors font-bold uppercase tracking-widest mt-0.5"
                    >
                      Overview
                    </Text>
                  </Link>
                ...
                {isSignedIn ? (
                  <div className="flex items-center gap-3 group">
                    <div className="text-right hidden xl:block">
                      <Text
                        variant="xs"
                        className="text-primary font-bold text-[9px] leading-none tracking-tight"
                      >
                        {user?.firstName || "Member"}
                      </Text>
                      <Text
                        variant="xs"
                        className="text-[7px] text-secondary font-black opacity-60"
                      >
                        Verified
                      </Text>
                    </div>
                    <UserButton
                      appearance={{
                        elements: {
                          avatarBox:
                            "w-8 h-8 md:w-9 md:h-9 rounded-full ring-1 ring-primary/5 hover:ring-secondary transition-all",
                          userButtonPopoverCard:
                            "shadow-xl border-none rounded-xl bg-surface",
                        },
                      }}
                    />
                  </div>
                  ...
                  <Button
                    asChild
                    className="hidden sm:flex bg-secondary text-white text-[9px] font-black tracking-widest uppercase px-5 h-8 rounded-full shadow-sm"
                  >
      ...
      <Sheet open={isMobileMenuOpen} onOpenChange={setIsMobileMenuOpen}>
        <SheetContent
          side="left"
          className="w-[80vw] sm:w-[300px] p-0 flex flex-col bg-surface border-r border-primary/5"
        >
          <SheetHeader className="p-4 border-b border-primary/5 text-left">
            <SheetTitle>
              <Heading
                variant="h3"
                className="text-lg tracking-tighter text-primary"
              >
                Menu
              </Heading>
            </SheetTitle>
          ...
          <ScrollArea className="flex-1 py-6 px-5">
            <div className="space-y-8">
              <div className="space-y-3">
                <Text variant="xs" className="text-primary/30 font-bold">
                  Shop
                </Text>
                ...
                <div className="space-y-4 pt-6 border-t border-primary/5">
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    >
                      ...
                      <Heading variant="h4" className="text-base text-primary">
                        Overview
                      </Heading>
                    </Link>
                    <Link
          ...
          {!isSignedIn && (
            <div className="p-5 border-t border-primary/5">
              <Button
                asChild
                size="lg"
                className="w-full bg-secondary h-12 rounded-xl font-bold uppercase tracking-widest text-[10px]"
              >
                <Link
                  href="/sign-in"
                  onClick={() => setIsMobileMenuOpen(false)}
