    ...
    <div className="min-h-screen bg-surface py-12 md:py-24">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <header className="mb-20 space-y-6 max-w-3xl">
          <Heading
            variant="h1"
            className="text-5xl md:text-7xl text-primary tracking-tighter border-l-8 border-secondary pl-8"
          >
            Our Collections
          </Heading>
          <Text
            variant="lead"
            className="text-primary/60 pl-8 text-xl leading-relaxed"
          >
            ...
            >
              <Card className="border-none bg-surface-container-low p-10 h-full flex flex-col justify-between transition-all duration-500 hover:shadow-2xl hover:-translate-y-2 rounded-[40px] relative overflow-hidden shadow-sm">
                ...
                <div className="relative z-10 space-y-6">
                  <Heading
                    variant="h2"
                    className="text-3xl text-primary group-hover:text-secondary transition-colors tracking-tight"
                  >
                    {category
                      .replace(/_/g, " ")
                ...
                <div className="relative z-10 mt-12">
                  <Button
                    variant="ghost"
                    className="p-0 text-secondary font-black tracking-widest uppercase text-xs group-hover:gap-6 transition-all gap-3 hover:bg-transparent"
                  >
                    Explore Collection
